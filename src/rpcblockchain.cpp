...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.push_back(Pair("chaivkcrk", blockindex->nChainWork.GetHex()));
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in vkc\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of vkc addresses\n"
...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"chaivkcrk\": \"xxxx\"     (string) total amount of work in active chain, in hexadecimal\n"
            "}\n"
            "\nExamples:\n" +
    ...
    obj.push_back(Pair("chaivkcrk", chainActive.Tip()->nChainWork.GetHex()));
    return obj;
}
...
UniValue getchaintips(const UniValue& params, bool fHelp)
{
    ...
    /* Build up a list of chain tips.  We start with the list of all
       known blocks, and svkcessively remove blocks that appear as pprev
       of another block.  */
