...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("YSW Core ysw-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ysw-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded YSW transaction") + "\n" +
                               "  ysw-tx [options] -create [commands]   " + _("Create hex-encoded YSW transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded YSW transaction
