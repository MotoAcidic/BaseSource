...
QFontDatabase::addApplicationFont(":/fonts/ysw_font");

QString windowTitle = tr("YSW Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a YSW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and YSW: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About YSW Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about YSW Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for YSW"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your YSW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified YSW addresses"));
    ...
    openAction->setStatusTip(tr("Open a YSW: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the YSW Wallet help message to get a list with possible YSW command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("YSW client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YSW network", "", count));
}
...
{
    QString strTitle = tr("YSW Wallet"); // default title
