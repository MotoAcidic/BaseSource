...
// Copyright (c) 2018-2019 The VKC developers
...
// Wallet
    ...
    if (settings.contains("nAnonymizeUccAmount"))
        SoftSetArg("-anonymizevkcamount", settings.value("nAnonymizeUccAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in vkc.cpp during shotdown to also remove the window positions
