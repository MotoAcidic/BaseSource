...
static const struct {
    ...
    {"main", QAPP_APP_NAME_DEFAULT, ":/icons/vkc", "", ":/images/splash"},
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/vkc_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/vkc_testnet", "[regtest]", ":/images/splash_testnet"}};
