 ...
 * VKC system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& xVKCDevKey() const { return vVKCDevKey; }
    const std::vector<unsigned char>& xVKCFundKey() const { return vVKCFundKey; }
...
protected:
    ...
    std::vector<unsigned char> vVKCDevKey;
    std::vector<unsigned char> vVKCFundKey;
    int nDevFee;
    int nFundFee;
    int nDefaultPort;
