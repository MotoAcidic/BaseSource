...
In order to support loading of multiple wallets in vkc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vkc.cpp.
...
Changes to vkc.cpp
----------------------
vkc.cpp is the entry point into vkc-qt, and as such, will require some minor modifications to provide hooks for
