...
In order to support loading of multiple wallets in ysw-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ysw.cpp.
...
Changes to ysw.cpp
----------------------
ysw.cpp is the entry point into ysw-qt, and as such, will require some minor modifications to provide hooks for
