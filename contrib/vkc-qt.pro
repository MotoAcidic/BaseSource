...
RESOURCES += src/qt/vkc.qrc src/qt/vkc_locale.qrc

TRANSLATIONS += src/qt/locale/vkc_bg.ts \
                src/qt/locale/vkc_de.ts \
                src/qt/locale/vkc_en.ts \
                src/qt/locale/vkc_es.ts \
                src/qt/locale/vkc_fi.ts \
                src/qt/locale/vkc_fr.ts \
                src/qt/locale/vkc_it.ts \
                src/qt/locale/vkc_ja.ts \
                src/qt/locale/vkc_pl.ts \
                src/qt/locale/vkc_pt.ts \
                src/qt/locale/vkc_ru.ts \
                src/qt/locale/vkc_sk.ts \
                src/qt/locale/vkc_sv.ts \
                src/qt/locale/vkc_vi.ts \
                src/qt/locale/vkc_zh_CN.ts \
                src/qt/locale/vkc_zh_TW.ts
