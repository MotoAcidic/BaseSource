...
RESOURCES += src/qt/ysw.qrc src/qt/ysw_locale.qrc

TRANSLATIONS += src/qt/locale/ysw_bg.ts \
                src/qt/locale/ysw_de.ts \
                src/qt/locale/ysw_en.ts \
                src/qt/locale/ysw_es.ts \
                src/qt/locale/ysw_fi.ts \
                src/qt/locale/ysw_fr.ts \
                src/qt/locale/ysw_it.ts \
                src/qt/locale/ysw_ja.ts \
                src/qt/locale/ysw_pl.ts \
                src/qt/locale/ysw_pt.ts \
                src/qt/locale/ysw_ru.ts \
                src/qt/locale/ysw_sk.ts \
                src/qt/locale/ysw_sv.ts \
                src/qt/locale/ysw_vi.ts \
                src/qt/locale/ysw_zh_CN.ts \
                src/qt/locale/ysw_zh_TW.ts
