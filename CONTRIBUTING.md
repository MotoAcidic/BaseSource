Contributing to YSW Core
============================

The YSW Core project operates an open contributor model where anyone is
...
The following applies to code changes to the YSW Core project, and is not to be
confused with overall YSW Network Protocol consensus changes.

Whether a pull request is merged into YSW Core rests with the project merge
...
Patches that change YSW consensus rules are considerably more involved than
...
Where a patch set proposes to change the YSW consensus, it must have been
...
The project leader is the release manager for each YSW Core release.
