Contributing to VKC Core
============================

The VKC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VKC Core project, and is not to be
confused with overall VKC Network Protocol consensus changes.

Whether a pull request is merged into VKC Core rests with the project merge
...
Patches that change VKC consensus rules are considerably more involved than
...
Where a patch set proposes to change the VKC consensus, it must have been
...
The project leader is the release manager for each VKC Core release.
