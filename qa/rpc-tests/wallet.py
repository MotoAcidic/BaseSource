...
#   c) node1 mines 32 blocks, so now node 0 has 60001ysw, node 1 has 4250ysw, node2 has none.
#   d) node0 sends 601 ysw to node2, in two transactions (301 ysw, then 300 ysw).
