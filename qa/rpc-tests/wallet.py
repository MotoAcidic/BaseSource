...
#   c) node1 mines 32 blocks, so now node 0 has 60001vkc, node 1 has 4250vkc, node2 has none.
#   d) node0 sends 601 vkc to node2, in two transactions (301 vkc, then 300 vkc).
